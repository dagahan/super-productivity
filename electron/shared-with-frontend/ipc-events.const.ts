...
export enum IPC {
  ...
  BLUETOOTH_SYNC_IS_AVAILABLE = 'BLUETOOTH_SYNC_IS_AVAILABLE',
  BLUETOOTH_SYNC_GET_LOCAL_DEVICE_NAME = 'BLUETOOTH_SYNC_GET_LOCAL_DEVICE_NAME',
  BLUETOOTH_SYNC_LIST_PAIRED_DEVICES = 'BLUETOOTH_SYNC_LIST_PAIRED_DEVICES',
  BLUETOOTH_SYNC_CONNECT = 'BLUETOOTH_SYNC_CONNECT',
  BLUETOOTH_SYNC_WRITE = 'BLUETOOTH_SYNC_WRITE',
  BLUETOOTH_SYNC_CLOSE_LINK = 'BLUETOOTH_SYNC_CLOSE_LINK',
  BLUETOOTH_SYNC_START_LISTENING = 'BLUETOOTH_SYNC_START_LISTENING',
  BLUETOOTH_SYNC_STOP_LISTENING = 'BLUETOOTH_SYNC_STOP_LISTENING',
  BLUETOOTH_SYNC_READ_SHARED_FILE = 'BLUETOOTH_SYNC_READ_SHARED_FILE',
  BLUETOOTH_SYNC_WRITE_SHARED_FILE = 'BLUETOOTH_SYNC_WRITE_SHARED_FILE',
  BLUETOOTH_SYNC_DELETE_SHARED_FILE = 'BLUETOOTH_SYNC_DELETE_SHARED_FILE',
  BLUETOOTH_SYNC_LIST_SHARED_FILES = 'BLUETOOTH_SYNC_LIST_SHARED_FILES',
  BLUETOOTH_SYNC_LINK_DATA = 'BLUETOOTH_SYNC_LINK_DATA',
  BLUETOOTH_SYNC_LINK_CLOSED = 'BLUETOOTH_SYNC_LINK_CLOSED',
  BLUETOOTH_SYNC_INCOMING_LINK = 'BLUETOOTH_SYNC_INCOMING_LINK',
  ...
  LOCAL_REST_API_GET_TOKEN = 'LOCAL_REST_API_GET_TOKEN',
  LOCAL_REST_API_REGENERATE_TOKEN = 'LOCAL_REST_API_REGENERATE_TOKEN',
